        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2">
              ...
              >
                {resource.viewType === 'pdf' ? 'Ver PDF' : 'Ver Word'}
              </Link>
              <a
